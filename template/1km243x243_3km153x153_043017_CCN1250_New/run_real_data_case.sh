...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/1km243x243_3km153x153_043017_CCN1250_New'
JOBNAME='CCN_1250_1km243x243_3km153x153_043017_NAM'
...
# 2 hour spin-up from 1400-1600 UTC 30 April 2017
...
python run_real_data_case.py  \
    ...
    --fcst-req 0:10  --init-fcst-req 1:15  --assim-on-req 0:45 --init-time-string 20170430060000 --check-radar-files                                                             \
