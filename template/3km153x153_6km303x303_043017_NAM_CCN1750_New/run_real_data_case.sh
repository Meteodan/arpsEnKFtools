...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/3km153x153_6km303x303_043017_NAM_CCN1750_New/'
JOBNAME='CCN_1750_3km153x153_6km303x303_043017_NAM_New'
...
python run_real_data_case.py  \
    ...
    --fcst-req 0:15  --init-fcst-req 0:45  --assim-on-req 1:00 --init-time-string 20170430060000 --check-radar-files                                                             \
