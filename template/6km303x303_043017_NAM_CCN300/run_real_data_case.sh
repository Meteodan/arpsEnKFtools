...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/6km303x303_043017_NAM_CCN300'
JOBNAME='CCN_300_6km303x303_043017_NAM'
...
python run_real_data_case.py  \
    --base-path $BASEPATH  --job-name $JOBNAME --user cbelak --queue standby                                       \
    ...
    --fcst-req 0:45  --init-fcst-req 3:15  --assim-on-req 0:45                                                              \
