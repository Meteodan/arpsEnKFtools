...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/1km243x243_3km153x153_043017/'
JOBNAME='1km243x243_3km153x153_043017_NAM_5_min'
...
python run_real_data_case.py  \
    ...
    --ens-start 39900  --ens-end 44100  --ens-step 300  --assim-step 300  --chunk-size 300                                   \
