...
python run_real_data_case.py  \
    ...
    --arps-template inputfiletemplates/arps_60.input  --arpsenkf-template inputfiletemplates/arpsenkf_5.input  --arpsenkfic-template inputfiletemplates/arpsenkfic.input      \
    --assim-radar 2017_IOP4C.radflag  --assim-prof no  --assim-surf no  --assim-sndg no                                                    \
    --covariance-inflation 0:mults=1.20,adapt=0.90 \
    --fcst-req 0:20  --init-fcst-req 0:15  --assim-on-req 1:15 --init-time-string 20170430060000 --check-radar-files                                                             \
