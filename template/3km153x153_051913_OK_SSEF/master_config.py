...
ext_model_data_dir = os.path.join(depot_base_dir, 'data/Projects/051913_OK/ARPS/EnKF',
                                  IOP_name)
...
radflag_file = '2013_0519_SSEF_just_KTLX.radflag'
...
radflag_param = {
    ...
    'radar_groups': {
        'all_radars': (arpsenkf_param['radarname'], np.arange(3600., 18000. + 900., 900.))
    },
}
