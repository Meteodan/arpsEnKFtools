...
python run_real_data_case.py  \
    ...
    --split-init auto --restart --debugi --save-batch --error-check

# 3km 31 March 2016 (nested in NEWS-e), radar data at 15-min intervals

# python run_real_data_case.py  \
#     --base-path /scratch/rice/d/dawson29/VORTEXSE/simulations/ARPS/2016_IOP3/EnKF/3km153x153_newse/  --job-name 3km153x153_newse_conv_rad_tst                                        \
#     --n-ens 36  --mpi-config-model 3 5 --mpi-config-dump 3 5 --mpi-config-enkf 3 5 --algorithm ensrf                                                                        \
#     --ens-start 900 --ens-end 31500 --ens-step 300  --assim-step 900  --chunk-size 900                                   \
#     --arps-template inputfiletemplates/arps.input  --arpsenkf-template inputfiletemplates/arpsenkf.input  --arpsenkfic-template inputfiletemplates/arpsenkfic.input      \
#     --assim-radar 2016_IOP3.radflag  --initial-conditions yes --assim-prof no  --assim-surf yes  --assim-sndg no                                                    \
#     --covariance-inflation 0:mults=1.20,adapt=0.90 \
