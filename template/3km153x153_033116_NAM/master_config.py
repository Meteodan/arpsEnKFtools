...
project_dir = 'Projects/033116_AL/ARPS'
...
ext_model_data_dir = os.path.join(depot_base_dir, 'data/Projects/033116_AL/model_data/NAM',
                                  IOP_name)
#ext_model_data_dir = os.path.join(depot_base_dir,
#                                  'data/Projects/VORTEXSE/model_data/newse_data')
sfc_obs_dir = os.path.join(depot_base_dir, 'data/Projects/033116_AL/obsdata/sao')
radar_obs_dir = os.path.join(depot_base_dir, 'data/Projects/033116_AL/obsdata/nexrad/level2/')
...
radremap_param = {
    ...
    'start_timestamp': '20160331194500',
