...
scratch_base_dir = '/scratch/rice/s/sbeverid'
depot_base_dir = '/depot/dawson29'
arpsenkftools_base_dir = '/home/sbeverid/arpsEnKFtools/'
...
ext_model_data_dir = os.path.join('/depot/dawson29/data/Projects/VORTEXSE/model_data/nam_data',
                                  IOP_name)
...
exp_name_base = '6km303x303_033116'
exp_name_tag = '_NAM'
...
arps_base_dir = '/home/sbeverid/arps5.4'
...
nocmnt = 2
comments = ['ARPS 5.4', 'March 31st, 2016 VORTEX-SE IOP3']
...
'initime': initial_datetime.strftime('%Y-%m-%d.%H:%M:00'),
    ...
    'extdtimes': [
        ...
        '2016-04-01.00:00:00+004:00:00',
        '2016-04-01.00:00:00+005:00:00',
    ],
    'iorder': 3,
    'intropt': 1,
    'nsmooth': 1,
