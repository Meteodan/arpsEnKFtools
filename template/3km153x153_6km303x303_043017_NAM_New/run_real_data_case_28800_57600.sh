...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/3km153x153_6km303x303_043017_NAM_New/'
...
python run_real_data_case.py  \
    ...
    --ens-start 28800  --ens-end 57600  --ens-step 300  --assim-step 300  --chunk-size 300                                   \
    ...
    --fcst-req 0:15  --init-fcst-req 2:45  --assim-on-req 0:45 --init-time-string 20170430060000 --check-radar-files                                                             \
