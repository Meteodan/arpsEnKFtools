...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/3km153x153_6km303x303_043017_NAM_CCN500_New/'
JOBNAME='CCN_500_3km153x153_6km303x303_043017_NAM'
...
python run_real_data_case.py  \
    ...
    --fcst-req 0:07  --init-fcst-req 1:00  --assim-on-req 0:45 --init-time-string 20170430060000 --check-radar-files                                                             \
