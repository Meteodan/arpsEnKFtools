...
ext_model_data_dir = os.path.join(IOP_scr_dir, '6km303x303_033022_0600_NAM/6km303x303_033022_0600_NAM')
sfc_obs_dir = os.path.join(depot_base_dir, 'data/Projects/PERiLS/obsdata/2022/sao/2012_IOP2')
radar_obs_dir = os.path.join(depot_base_dir, 'data/Projects/PERiLS/obsdata/2022/NEXRAD/IOP2/level2_links')
# TODO: add other obs type directories here

# Experiment name and directories
exp_name_base = '3km153x153_6km303x303_033022'
exp_name_tag = '_NAM'
...
radflag_file = '2022_IOP2.radflag'
...
radremap_exe_path = os.path.join('/home/dawson29/arps5.4_main_gnu/bin', '88d2arps')
...
radremap_param = {
    'radar_list': ['KBMX', 'KDGX', 'KGWX', 'KHTX', 'KNQA'],
    'start_timestamp': '20220330120000',
    'end_timestamp': '20220331030000',
...
arpsenkf_param = {
    'nrdrused': 5,
    'radarname': ['KBMX', 'KDGX', 'KGWX', 'KHTX', 'KNQA'],
    'ntwtype': [1, 1, 1, 1, 1],
...
radflag_param = {
    ...
    'radar_groups': {
        'all_radars': (arpsenkf_param['radarname'], np.arange(21600., 75600. + 900., 900.))
    },
}
