...
BASEPATH='/scratch/bell/dawson29/Projects/PERiLS/simulations/ARPS/2022_IOP2/EnKF/3km153x153_6km303x303_033022_NAM/'
JOBNAME='3km153x153_6km303x303_033022_NAM'
...
# 3-km 30 March 2022
# 15-min cycle assimilating radar obs from 1200 30 March 2022 to 0300 UTC 31 March 2022
python run_real_data_case.py  \
    ...
    --assim-radar 2022_IOP2.radflag  --assim-prof no  --assim-surf no  --assim-sndg no                                                    \
