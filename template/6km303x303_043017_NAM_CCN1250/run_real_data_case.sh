...
BASEPATH='/scratch/rice/c/cbelak/Projects/VORTEXSE/simulations/ARPS/2017_IOP4C/EnKF/6km303x303_043017_NAM_CCN1250/'
JOBNAME='6km303x303_043017_NAM_CCN1250'
...
#     --assim-radar no  --assim-prof no  --assim-surf yes  --assim-sndg no                                                    \
#     --covariance-inflation 0:mults=1.20,adapt=0.90 \
#     --fcst-req 1:15  --init-fcst-req 0:15  --assim-on-req 0:45                                                              \
