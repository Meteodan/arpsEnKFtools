...
basedir = '/scratch/rice/d/dawson29/Projects/VORTEXSE/simulations/ARPS/2016_IOP3/EnKF/6km153x153_033116_NAM/6km153x153_033116_NAM/' # Base directory name where individual
                                                                # run folders reside
...
master_time_list = [N.arange(900.0,54900.0+900.0,900.0)] * 2
start_timestamp_list = ['20160331120000'] * 2
