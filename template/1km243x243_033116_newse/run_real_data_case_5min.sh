...
BASEPATH='/scratch/rice/d/dawson29/Projects/VORTEXSE/simulations/ARPS/2016_IOP3/EnKF/1km243x243_033116_newse/'
JOBNAME='1km243x243_033116_newse'
...
python run_real_data_case.py  \
    ...
    --assim-radar 2016_IOP3_5min.radflag  --initial-conditions yes --assim-prof no  --assim-surf no  --assim-sndg no                                                    \
    --covariance-inflation 0:mults=1.20,adapt=0.90 \
    --fcst-req 0:30  --init-fcst-req 1:00  --assim-on-req 1:00                                                              \
