...
dir_list = ['./ENamean/','./ENfmean/','./EN010/','./ENF010/']
dir_extra_list = ['./','./','./','./']
runname_list = ['enmean','efmean','ena010','enf010']
runlabel_list = ['enmean','efmean','ena010','enf010']
trailer_list = ['','','','']
mphyopt_list = [15,15,15,15]
plotlim_list = [None,None,None,None]
master_time_list = [N.arange(14400.0,14400.0+300.0,300.0), N.arange(14400.0,14400.0+900.0,900.0),
                    N.arange(1800.0,1800.0+300.0,300.0), N.arange(1800.0,1800.0+300.0,300.0)]
arbfile_list = [None,None,None,None]

# Variables to plot

fieldname = "u"
fieldlevels = N.arange(-150.0,150.0+10.0,10.0)
