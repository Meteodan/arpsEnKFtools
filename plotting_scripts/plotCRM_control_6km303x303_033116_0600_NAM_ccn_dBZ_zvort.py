...
basedir = '/scratch/rice/d/dawson29/Projects/VORTEXSE/simulations/ARPS/2016_IOP3/EnKF/6km303x303_033116_0600_NAM/6km303x303_033116_0600_NAM_tmix4/' # Base directory name where individual
                                                                # run folders reside
outdirname = basedir+'plots/' # The directory name where the simulated dual-pol data will be saved.
toPlot_list = [False,False,True]
dir_list = ['./ENamean/','./ENfmean/','./EN001/']
dir_extra_list = ['./','./','./']
runname_list = ['enmean','efmean','ena001']
runlabel_list = ['enmean','efmean','ena001']
trailer_list = ['','','']
mphyopt_list = [15,15,15]
plotlim_list = [[650000., 1200000., 700000., 1150000.], [650000., 1200000., 700000., 1150000.],None]
master_time_list = [N.arange(15300.,54000.0+900.,900.), N.arange(15300.,54000.0+900.0,900.0),N.arange(0.,75600.+300.,300.)]
start_timestamp_list = ['20160331161500', '20160331161500','20160331060000']
arbfile_list = [None,None,None]

# Variables to plot

fieldname = "ccn"
fieldlevels = N.arange(0.0,1.e9+1.e8,1.e8)
clvls = matplotlib.ticker.MultipleLocator(base=1.0e8)
clabel = r'$CCN$'
cformat = None
fieldcm = cm.viridis
