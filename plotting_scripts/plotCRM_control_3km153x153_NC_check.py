...
basedir = '/scratch/rice/d/dawson29/VORTEXSE/simulations/ARPS/2016_IOP3/EnKF/3km153x153_newse/3km153x153/' # Base directory name where individual
                                                                # run folders reside
...
dir_list = ['./ENamean/','./ENfmean/','./EN009/','./ENF001/']
dir_extra_list = ['./','./','./','./']
runname_list = ['enmean','efmean','ena009','enf001']
runlabel_list = ['enmean','efmean','ena009','enf001']
trailer_list = ['','','','']
mphyopt_list = [15,15,15,15]
plotlim_list = [None,None,None,None]
master_time_list = [N.arange(0.0,7200.0+300.0,300.0), N.arange(16200.0,18900.0+900.0,900.0),
                    N.arange(10200.0,10200.0+300.0,300.0), N.arange(0.0,7200.0+300.0,300.0)]
arbfile_list = [None,None,None,None]

# Variables to plot

fieldname = "Ntc"
fieldlevels = N.arange(-1.0e9,1.0e8+0.1e8,0.1e8)
clvls = matplotlib.ticker.MultipleLocator(base=0.1e8)
clabel = r'N$_{Tc}$ m$^{-3}$'
cformat = None
fieldcm = cm.RdBu_r
norm = None # matplotlib.colors.BoundaryNorm(fieldlevels,fieldcm.N)
plabel = None
slice1 = 8
stag = 's'

fieldovername = "none" # "w"
fieldoverlevels = N.arange(5.0,60.0+5.0,5.0)
fieldovercolor = 'k'
slice2 = 14
stagovr = 's'

fieldover2name = "none" # "zvort"
