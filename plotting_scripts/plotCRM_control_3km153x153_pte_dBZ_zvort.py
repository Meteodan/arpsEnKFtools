...
basedir = '/scratch/rice/d/dawson29/VORTEXSE/simulations/ARPS/2016_IOP3/EnKF/3km153x153/3km153x153/' # Base directory name where individual
                                                                # run folders reside
outdirname = basedir+'plots/' # The directory name where the simulated dual-pol data will be saved.
toPlot_list = [True,True]
dir_list = ['./EN001/','./ENF001/']
dir_extra_list = ['./','./']
runname_list = ['ena001','enf001']
runlabel_list = ['ena001','enf001']
trailer_list = ['','']
mphyopt_list = [15,15]
plotlim_list = [None,None]
master_time_list = [N.arange(22500.0,22500.0+3600.0,3600.0), N.arange(22500.0,22500.0+3600.0,3600.0)]
