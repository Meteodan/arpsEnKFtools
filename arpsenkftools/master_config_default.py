...
arpsenkftools_base_dir = os.path.join(depot_base_dir, 'apps/arpsEnKFtools/template')
project_dir = 'Projects/VORTEXSE/simulations/ARPS/EnKF'
project_scr_dir = os.path.join(scratch_base_dir, project_dir)
project_depot_dir = os.path.join(depot_base_dir, project_dir)
IOP_name = '2017_IOP4C'
IOP_scr_dir = os.path.join(project_scr_dir, IOP_name)
IOP_depot_dir = os.path.join(project_depot_dir, IOP_name)
