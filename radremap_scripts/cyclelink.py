...
inDir = "/depot/dawson29/data/VORTEXSE/simulations/ARPS/2016_IOP3/processed_radar/"+radname+"_153x153/"
...
for t in timeList:
    ...
    cmd = "ln -sf " + gtFile[tind] + " " + os.path.join(inDir, gtFilename[:4] + "." + t.strftime("%Y%m%d.%H%M%S"))
