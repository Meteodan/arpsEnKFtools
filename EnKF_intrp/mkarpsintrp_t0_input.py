...
template = "/nsftor/rtanamachi/cases/26may2010/arps/realdata/1km_enkf/input/arpsintrp_t0.input.template"
# Absolute path to where the resulting radremap_88D.input files should be stored.
rinPath = "/nsftor/rtanamachi/cases/26may2010/arps/realdata/1km_enkf/input/arpsintrp_t0_input"
